...
public class GlobalConstants {
	...
	public static final String REPORTING_SCREENSHORT = PROJECT_PATH + File.separator + "ReportNGImages" + File.separator;
	public static final String EXTENTV2_PATH = PROJECT_PATH + File.separator + "extentV2" + File.separator;
